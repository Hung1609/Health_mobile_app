...
const Resource = () => {
    ...
    const fetchVideos = async () => {
        setIsLoading(true);
        try {
            const response = await fetch("http://192.168.1.102:8000/videos"); // Change this to your actual server URL
                ...
                <View className="w-full h-full flex-1 px-4 bg-white">
                    <View className="flex-row items-center justify-between mt-10">
                        ...
                        <View className="flex-row space-x-1">
                            ...
                            <Pressable
                                onPress={() =>
                                    router.push("/Other Tabs/profile")
                                }
                            >
                                <Icon
                                    className="px-2"
                                ...
                                {isLoading ? (
                                    ...
                                    <View className="flex-row flex-wrap justify-between">
                                        {videos.map((video) => (
                                            <View
                                                key={video.videoId}
                                                className="w-[48%] bg-gray-100 border-blue-500 border-2 rounded-lg overflow-hidden mb-4"
                                            >
                                                {playingVideoId ===
                                                video.videoId ? (
                                                    <View
